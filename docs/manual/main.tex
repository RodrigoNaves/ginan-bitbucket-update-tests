...
\newcommand{\authors}[0]{Sebastien Allegyer, Rupert Brown, John Donovan,
...
\begin{document}
	...
	\vspace{2.75in}{\fontsize{36}{54}\selectfont Ginan\par}
	\vspace{0.1in}{\fontsize{14}{14}\selectfont\textsf{version 1.0-alpha}\par}
