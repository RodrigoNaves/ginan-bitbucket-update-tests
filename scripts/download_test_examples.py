...
ex6SrcDir = S3bucket + 'examples/ex6/'
ex6SrcSolDir = ex6SrcDir + 'solution/'
...
ex6DestDir = destDir + '/ex6/'
ex6DestSolDir = ex6DestDir + 'solution/' 
#===============================================================================
...
#  perl -i -pe 's%\n%%g' data.listing
# just some junk to force a retest
...
#ex2SolFiles = ('pod.out','pod_C.rms','pod_E.rms','pod_G.rms','pod_R.rms', 'gag20624.sp3')
...
# EX4 files
#
ex4Files = ('EQM.in','POD.in','VEQ.in','igs20624.sp3','gag20624_orbits_partials.out.ecom2_pea')
ex4SolFiles = ('pod.out','pod.rms', 'gag20624.sp3')
#
# EX5 files
#
...
# EX6 files
#
ex6Files = ('EQM.in','POD.in','VEQ.in','ilrsa.orb.lageos1.201128.v70.sp3')
ex6SolFiles = ('pod.out','pod.rms')
...
#
downloadfiles(ex6SrcDir,ex6DestDir,ex6Files)
downloadfiles(ex6SrcSolDir,ex6DestSolDir,ex6SolFiles)
