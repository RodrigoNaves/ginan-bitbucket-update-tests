...
filename = yml_output_dir // "/" // "orb_itrf.out"
...
filename = yml_output_dir // "/" // "VEQ_Smatrix.out"
!Call writearray (veqSmatrix, filename)
filename = yml_output_dir // "/" // "VEQ_Pmatrix.out"
!Call writearray (veqPmatrix, filename)
End IF

!IF (PRN == 'G02') THEN
!print *,"extorbcomp prn", PRN
filename = yml_output_dir // "/" // "dorb_icrf_ext.out"
Call writearray (dorb_icrf, filename)

filename = yml_output_dir // "/" // "dorb_rtn_ext.out"
